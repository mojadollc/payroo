      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          <div className="rounded-xl border bg-card p-3">
            ...
            <p className="text-[15px] font-bold text-amber-600">₱{fmt(totals.gross)}</p>
          ...
          <div className="rounded-xl border bg-card p-3">
            <p className="text-[11px] text-muted-foreground flex items-center gap-1 mb-1">
              <Cigarette className="h-3 w-3" /> Sticks Sold
            </p>
          ...
          <div className="rounded-xl border bg-card p-3">
            ...
            <p className="text-[10px] text-muted-foreground mt-0.5">Current stock value</p>
          </div>
        </div>
      </div>
