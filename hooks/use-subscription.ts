...
export function useSubscription() {
  const [state, setState] = useState<SubscriptionState>(() => {
    ...
    return readCache() ?? { loading: true, isActive: false, isDeactivated: false, tier: null, features: DEFAULT_FEATURES, storeName: null, businessType: null, ownerName: null, ownerEmail: null, endDate: null, externalId: null }
  })
