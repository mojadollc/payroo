...
// ─── Shared context ────────────────────────────────────────────────────────
// Previously every component (Navbar, MobileBottomNav, AuthGuard, and any
// page) called the fetch-on-mount hook independently — meaning up to 4
// duplicate Firestore reads, 4 setIntervals, and 4 visibilitychange listeners
// firing at once on a single page. That's the main thing that made
// navigating around the app feel sluggish. Now there's one fetch, shared via
// context, and every existing `useSubscription()` call site keeps working
// unchanged.
...
export function useSubscription(): SubscriptionState {
  ...
  // Falls back to the standalone (non-shared) implementation if a consumer
  // is rendered outside <SubscriptionProvider> — keeps this a safe drop-in.
